        ...
        <ol className="relative border-l border-gray-200 dark:border-gray-700 mb-24 mt-16">
            <li className="mb-10 ml-6">
                ...
                <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
                    Dilaksanakan Pada <br className="md:hidden" /> 11 Juli 2023 - 11 Agustus 2023
                </time>
            ...
            <li className="mb-10 ml-6">
                ...
                <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
                    Dilaksanakan Pada <br className="md:hidden" /> 12 Agustus 2023 - 15 Agustus 2023
                </time>
                <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
                    Tahap seleksi karya oleh panitia.
                </p>
            </li>
            <li className="mb-10 ml-6">
                <span
                ...
                <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
                    Dilaksanakan Pada <br className="md:hidden" /> 16 Agustus 2023
                </time>
                <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
                    Pengumuman akan diumumkan di grup WhatsApp.
                </p>
            </li>
            <li className="mb-10 ml-6">
                <span
                ...
                <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
                    Dilaksanakan Pada <br className="md:hidden" /> 18 Agustus 2023
                </time>
                <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
            ...
            <li className="mb-10 ml-6">
                ...
                <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">
                    Persiapan Presentasi Peserta
                    {/*<span className="bg-red-100 text-red-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ml-3 max-[768px]:text-center">*/}
                    {/*    Segera Dilaksanakan*/}
                    {/*</span>*/}
                </h3>
                <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
                    Dilaksanakan Pada <br className="md:hidden" /> 19 Agustus 2023 - 21 Agustus 2023
                </time>
                <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
                    Peserta menyiapkan bahan presentasi serta membuat bahan presentasi dalam bentuk PPT.
                </p>
            </li>
            <li className="mb-10 ml-6">
                <span
                ...
                <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
                    Dilaksanakan Pada <br className="md:hidden" /> 22 Agustus 2023
                </time>
                <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
                    Peserta akan presentasi PPT serta Karya yang telah dibuat kepada Juri.
                </p>
            </li>
        </ol>
    );
...
export default TimelineContest;

        ...
        <ol className="relative border-l border-gray-200 dark:border-gray-700 mb-24 mt-16">
            <li className="mb-10 ml-6">
                ...
                <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
                    Dilaksanakan Pada <br className="md:hidden" /> 01 Juli 2023 - 05 Agustus 2023
                </time>
            ...
            <li className="mb-10 ml-6">
                ...
                <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
                    Dilaksanakan Pada <br className="md:hidden" /> 06 Agustus 2023 - 11 Agustus 2023
                </time>
                <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
                    Seluruh karya peserta yang sudah dikumpulkan akan diseleksi oleh panitia.
                </p>
            </li>
            <li className="mb-10 ml-6">
                <span
                ...
                <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
                    Dilaksanakan Pada <br className="md:hidden" /> 12 Agustus 2023
                </time>
                <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
            ...
            <li className="mb-10 ml-6">
                ...
                <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
                    Dilaksanakan Pada <br className="md:hidden" /> 14 Agustus 2023
                </time>
                <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
            ...
            <li className="mb-10 ml-6">
                ...
                <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
                    Dilaksanakan Pada <br className="md:hidden" /> 15 Agustus 2023 - 20 Agustus 2023
                </time>
                <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
            ...
            <li className="mb-10 ml-6">
                ...
                <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
                    Dilaksanakan Pada <br className="md:hidden" /> 21 Agustus 2023
                </time>
                <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">

                ...
                <Accordion.Panel>
                    ...
                    <Accordion.Content>
                        <p className="mb-2 text-gray-500 dark:text-gray-400">
                            Lomba pada kali ini dibukan untuk Mahasiswa Sistem Informasi Universitas Singaperbangsa Karawang.
                        </p>
                    </Accordion.Content>
                </Accordion.Panel>
                <Accordion.Panel>
                    ...
                    <Accordion.Content>
                        <p className="mb-2 text-gray-500 dark:text-gray-400">
                            Persyaratan pada lomba kali ini yaitu, para peserta yang akan mendaftar harus merupakan Mahasiswa Universitas Singaperbangsa Karawang dengan dibuktikan dengan tanda pengenal KTM ataupun mendaftar dengan email kampus UNSIKA.
                        </p>
                    </Accordion.Content>
                </Accordion.Panel>
                <Accordion.Panel>
                    ...
                    <Accordion.Content>
                        <p className="mb-2 text-gray-500 dark:text-gray-400">
                            Tema untuk seluruh lomba yang ada yaitu "Teknologi & Bisnis". Dimana semua karya harus berhubungan dengan teknologi dan bisnis.
                        </p>
                    </Accordion.Content>
                </Accordion.Panel>
                <Accordion.Panel>
...
export default QuestionAnswerExhibiton;

        ...
        <ol className="relative border-l border-gray-200 dark:border-gray-700 mb-24 mt-16">
            <li className="mb-10 ml-6">
                ...
                <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
                    Dilaksanakan Pada <br className="md:hidden" /> 26 Juli 2023 - 23 Agustus 2023
                </time>
                <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
                    Para calon peserta yang akan mengikuti Talkshow diwajibkan untuk mendaftar pada tombol dibawah!
                </p>
                <Link
                    to="/silogy-expo/talkshow"
            ...
            <li className="mb-10 ml-6">
                ...
                <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
                    Dilaksanakan Pada <br className="md:hidden" /> 15 September 2023
                </time>
                <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
...
export default TimelineTalkshow;

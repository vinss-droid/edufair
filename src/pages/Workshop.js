...
import WorkshopPamphlet from '../img/pamphlet/webinar.jpg'
    ...
    return (
        <div>
            ...
            <Helmet>
                ...
                <meta property="og:image" content={WorkshopPamphlet} />
            ...
            <div className="container mx-auto mt-10 mb-6 px-8">
                ...
                <div className="flex flex-row max-[992px]:flex-col-reverse justify-center my-14">
                    ...
                    <div className="w-6/12 max-[992px]:w-full">
                        <img src={WorkshopPamphlet} alt="workshop.png" className="mx-auto w-[70%] rounded-md"/>
                    </div>
                </div>
